...
<body>
	...
	<main>
		<section>
			<form method="post">
				<input type="search" name="recherche" placeholder="Nom, Prénom">
			...
			<form method="post">
				...
				<input name=InsereID class="champ" type="text" placeholder="ID" size="4">
			...
			<form method="post">
				...
				<input name=ModifieID class="champ" type="text" placeholder="ID" size="4" >
			...
			<br>
			<form method="post">
				<input type="search" name="SupprimeID" placeholder="Saisissez l'ID" size="4">
				<input type="submit" name="7" value="SUPPRIMER (Attention c'est dangereux)" />
			</form>
			<br>
			<div>
				<?php
				include('M_Membre.php');
				?>
			</div>
		</section>
	</main>
