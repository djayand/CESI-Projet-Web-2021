	...
	<main>
		<form action="M_Subscribe.php" method="post">
			<ul class="col-md-2 col-lg-2 liste">
				...
				<li><input name=ilog class="champ" type="text" placeholder="example85" maxlength="10" size="20" required></li>
				...
				<br>
				<li><input type="submit" onclick="validate()" value="Valider" id="envoyer" class="btn-secondaire"></li>
			</ul>
		</form>
	</main>
</body>
