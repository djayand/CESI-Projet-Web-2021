...
<body>
	...
	<main>
		...
		<div>NOTE TUTEUR : </div>
		<div>DESCRIPTIF : </div>
		<div><button class="favorite styled" type="button">
				ENTREPRISE
			</button>
		</div>
		...
		<p>
			...
			La gratification des stagiaires étant en perpétuelle évolution, dès le 1er septembre 2015, elle passera à 15 % (soit 3,60 euros par heure) selon le plafond horaire de la sécurité sociale contre les 12,5 % (soit 3,16 euros) prévus par la loi de juillet 20141
